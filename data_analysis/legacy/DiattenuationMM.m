...
close all;
mkdir(['D:\Measurements\Air_Calibrations\New_Diffuser\Diattenuation\dichroic-45-small-ROI-' date]);
...
for n = 1:nLambda
    ...
    saveas(gcf,fullfile(['D:\Measurements\Air_Calibrations\New_Diffuser\Diattenuation\dichroic-45-small-ROI-' date],['Lambda ' num2str(LambdaList(n)) '_' date '.png']));
    close all;
end
...
saveas(gcf,fullfile(['D:\Measurements\Air_Calibrations\New_Diffuser\Diattenuation\dichroic-45-small-ROI-' date],['Avg_Dia_Lambda.png']));
